...
import com.example.quicknews.ArticleDetailsActivity;
...
public class NewsAdapter extends RecyclerView.Adapter<NewsAdapter.NewsViewHolder> {
    ...
    public NewsAdapter(Context context, ArrayList<Article> articleList, OnViewMoreClickListener onViewMoreClickListener) {
